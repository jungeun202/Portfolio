...
const experiences = [
  {
    ...
    description: "I work with DIAL ventures." ,
    stack: [
      {name: "Tableau"}, {name: "MySQL"}
    ],
  ...
  },
  {
    ...
    description: "I work with LRNING lab." ,
    stack: [
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none"> 
            ...
            {/* project category */}
            <h2 className="text-[42px] font-bold leading-none text-900 group-hover:text-accent transition-all duration-500 capitalize"> {experience.category} project</h2>
            {/* project description */}
                ...
                <SwiperSlide key={index} className="w-full">
                  ...
                  {/* image */}
                    <div className="relative w-full h-full">
                      <Image src={experience.image} fill className="ovject-cover" alt="">
                      </Image>
                    </div>
                  {/* overlay */}
                  </div>
